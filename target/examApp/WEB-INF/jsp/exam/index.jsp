    ...
    <table class="table table-striped" id="tbl">
        ...
        <c:forEach items="${exams}" var="exam">
            <tr>
                ...
                <td>${exam.desc}</td>
                <td>${exam.date}</td>
                <td>${exam.validFlag}</td>
                    <%--<td><a href="/exam/update/${exam.id}" data-toggle="modal" data-target="#updExam">修改试卷</a></td>--%>
                    <%--<td> <a href="/exam/delete/${exam.id}" data-toggle="modal" data-target="#delExam">删除试卷</a></td>--%>
